...
Quanto ao mapeamento de lateralidade, a alocação dos macro-controles (seleção de oitavas e volume) para a \textbf{mão não dominante} revelou-se natural. Constatou-se, contudo, que tocar articulações com a mão dominante enquanto se realizam saltos simultâneos de oitava com a mão não dominante exige coordenação e prática prévia por parte do executante. Por outro lado, performances confinadas a uma única oitava, utilizando ambas as mãos predominantemente para timbre e intensidade, demonstraram uma fluidez e curva de aprendizagem bastante acessíveis.
...
O teste foi conduzido num ambiente não controlado (doméstico). Foi fornecida a P1 uma breve instrução verbal, com duração inferior a 5 minutos, explicando a separação funcional da lateralidade (a mão dominante executa notas e a mão não dominante controla a região das oitavas e o volume). 
