...
Por fim, a existência de até 16 grupos independentes, cada um com 16 canais, permite separar fluxos de controle distintos — por exemplo, gestos da mão de controle e da mão de articulação podem ser alocados a grupos distintos, evitando colisão de comandos. Essa organização refletiu-se diretamente na arquitetura interna do Aerochord, onde a camada de roteamento destina os eventos aos grupos de forma estruturada, sustentando a baixa latência exigida.
