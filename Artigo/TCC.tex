...
\include{2-textuais/2-Referencial}
\include{2-textuais/3-Conclusoes}
\include{2-textuais/2-interacao_gestual_e_hiperinstrumentos}
\include{2-textuais/3-computacao_musical_e_protocolo_midi.tex}
\include{2-textuais/4-estado_arte_interfaces_musicais_gestuais}
\include{2-textuais/5-proposta_de_solucao.tex}
\include{2-textuais/6-conclusao.tex}
